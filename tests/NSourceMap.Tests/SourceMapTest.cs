...
13) [1,0,0,1]                                       ([0,47](#0)=>[13,1])
        ...
        public void SimpleGeneratorTest()
        {
            ...
            var stdin = "<stdin>";
            generator.AddMapping(stdin, new FilePosition(0, 0), new FilePosition(0, 0));
            generator.AddMapping(stdin, new FilePosition(0, 1), new FilePosition(1, 0));
            generator.AddMapping(stdin, new FilePosition(0, 2), new FilePosition(1, 3));
            generator.AddMapping(stdin, new FilePosition(0, 3), new FilePosition(2, 0));
